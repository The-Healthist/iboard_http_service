...
// @Accept       json
// @Produce      json
// @Param        building body object true "建筑信息"
// @Param        name formData string true "建筑名称" example:"星汇中心"
// @Param        ismartId formData string true "智慧建筑ID" example:"BLG1001"
// @Param        remark formData string false "备注" example:"位于中心城区的甲级写字楼"
// @Param        location formData string false "位置" example:"广州市天河区珠江东路28号"
// @Success      200  {object}  map[string]interface{} "返回创建的建筑信息"
// @Failure      400  {object}  map[string]interface{} "错误信息"
// @Router       /admin/building [post]
// @Security     BearerAuth
func (c *BuildingController) Create() {
	var form struct {
		Name     string `json:"name" binding:"required" example:"星汇中心"`
		IsmartID string `json:"ismartId" binding:"required" example:"BLG1001"`
		Remark   string `json:"remark" example:"位于中心城区的甲级写字楼"`
		Location string `json:"location" example:"广州市天河区珠江东路28号"`
	}
...
// 2.Get 获取建筑列表
// @Summary      获取建筑列表
// @Description  根据查询条件获取建筑列表
// @Tags         Building
// @Accept       json
// @Produce      json
// @Param        search query string false "搜索关键词" example:"星汇"
// @Param        pageSize query int false "每页数量" default(10)
// @Param        pageNum query int false "页码" default(1)
// @Param        desc query bool false "是否降序" default(false)
// @Success      200  {object}  map[string]interface{} "返回建筑列表和分页信息"
// @Failure      400  {object}  map[string]interface{} "错误信息"
// @Router       /admin/building [get]
// @Security     BearerAuth
func (c *BuildingController) Get() {
	var searchQuery struct {
		Search string `form:"search" example:"星汇"`
	}
...
// @Accept       json
// @Produce      json
// @Param        building body object true "建筑更新信息"
// @Param        id formData uint true "建筑ID" example:"1"
// @Param        name formData string false "建筑名称" example:"星汇国际中心"
// @Param        ismartId formData string false "智慧建筑ID" example:"BLG1001-A"
// @Param        remark formData string false "备注" example:"位于中心城区的甲级写字楼，2023年重新装修"
// @Param        location formData string false "位置" example:"广州市天河区珠江东路28号"
// @Success      200  {object}  map[string]interface{} "更新成功消息"
// @Failure      400  {object}  map[string]interface{} "错误信息"
// @Router       /admin/building [put]
// @Security     BearerAuth
func (c *BuildingController) Update() {
	var form struct {
		ID       uint   `json:"id" binding:"required" example:"1"`
		Name     string `json:"name" example:"星汇国际中心"`
		IsmartID string `json:"ismartId" example:"BLG1001-A"`
		Remark   string `json:"remark" example:"位于中心城区的甲级写字楼，2023年重新装修"`
		Location string `json:"location" example:"广州市天河区珠江东路28号"`
	}
...
// 4.Delete 删除建筑
// @Summary      删除建筑
// @Description  删除一个或多个建筑
// @Tags         Building
// @Accept       json
// @Produce      json
// @Param        ids body object true "建筑ID列表"
// @Param        ids.ids body []uint true "建筑ID数组" example:"[1,2,3]"
// @Success      200  {object}  map[string]interface{} "删除成功消息"
// @Failure      400  {object}  map[string]interface{} "错误信息"
// @Router       /admin/building [delete]
// @Security     BearerAuth
...
// 5.GetOne 获取单个建筑
// @Summary      获取单个建筑
// @Description  根据ID获取建筑详细信息，包含关联设备
// @Tags         Building
// @Accept       json
// @Produce      json
// @Param        id path int true "建筑ID" example:"1"
// @Success      200  {object}  map[string]interface{} "返回建筑详细信息"
// @Failure      400  {object}  map[string]interface{} "错误信息"
// @Failure      404  {object}  map[string]interface{} "建筑不存在"
// @Router       /admin/building/{id} [get]
// @Security     BearerAuth
...
// 6.SyncNotice 同步建筑通知
// @Summary      同步建筑通知
// @Description  从旧系统同步指定建筑的通知到新系统
// @Tags         Building
// @Accept       json
// @Produce      json
// @Param        id path int true "建筑ID" example:"1"
// @Success      200  {object}  map[string]interface{} "同步结果，包含成功数量、失败通知等信息"
// @Failure      400  {object}  map[string]interface{} "错误信息"
// @Router       /admin/building/{id}/sync_notice [post]
// @Security     BearerAuth
...
// 7.ManualSyncNotice 手动同步建筑通知
// @Summary      手动同步建筑通知
// @Description  手动触发建筑通知同步过程
// @Tags         Building
// @Accept       json
// @Produce      json
// @Param        id path int true "建筑ID" example:"1"
// @Success      200  {object}  map[string]interface{} "同步结果详情"
